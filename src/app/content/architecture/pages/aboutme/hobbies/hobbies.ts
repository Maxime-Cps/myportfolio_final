  ...
  private hobbyConfigs: IHobbyConfig[] = [
    {
      ...
      media: [{ type: 'image', src: 'assets/img/messmocky2.PNG', mode: 'cover' }],
    ...
    },
    {
      ...
      media: [{ type: 'image', src: 'assets/img/me-golf.jpg', mode: 'cover' }],
    ...
    },
    {
      ...
      media: [{ type: 'image', src: 'assets/img/core.png', mode: 'contain' }],
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
